...
New participants should start with the [Onboarding Guide](ONBOARDING.md). Proposed presentations and unresolved discussion items are tracked in [Outstanding Agenda Topics](AGENDA.md).
...
* **Chair: Grant Miller [@grantdmiller](https://github.com/grantdmiller)** - IBM
* **Co-Chair: Alper Dedeoğlu [@alperdedeoglu](https://github.com/alperdedeoglu)** - SAP SE
